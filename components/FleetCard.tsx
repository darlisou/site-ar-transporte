      ...
      <div className="relative h-[420px] overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 text-white luxury-transition">
          <div className="flex items-center gap-3 mb-3">
             ...
             <p className="text-ar-blue font-bold text-xs uppercase tracking-[0.3em]">{ship.type === 'cargo' ? 'Heavy Duty' : 'High Speed'}</p>
          </div>
          <h4 className="font-display font-extrabold text-3xl mb-4 tracking-tight">{ship.name}</h4>
          <p className="text-white/70 text-sm font-medium max-w-sm leading-relaxed">{ship.tag}</p>
        </div>
      </div>
      ...
      <div className="p-12">
        <div className="flex justify-between items-center mb-10">
          <div className="space-y-1">
            <h3 className="text-[10px] font-bold text-ar-slate uppercase tracking-widest">Especificações do Equipamento</h3>
            <p className="text-ar-navy font-display font-bold text-lg">Industrial Reliability</p>
          </div>
